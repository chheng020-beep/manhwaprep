...
class MainWindow(QWidget):
    def __init__(self):
        ...
        self.quality.addItem("Balanced — MI-GAN (~2s/page)", "migan")
        self.quality.addItem("Best — LaMa (slow, ~10s/page)", "lama")
        self.quality.addItem("Fast — Telea (lowest quality)", "telea")
